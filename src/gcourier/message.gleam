...
//// 
//// The core data type is `Message`. You can create a message using the `message.build` function.
//// Every `Message` MUST have a `from` field and at least one Recipient in the `to field.
//// 
//// ## Example:
//// 
//// ```gleam
...
//// ```
//// 
//// The above code will produce the following email:
//// ```
////  Date: Mon, 7 May 2025 22:59:34 +00:00
////  From: The Fun Club 🎉 <party@funclub.org>
////  To: jane.doe@example.com
////  Cc: john.doe@example.net
////  Subject: You're Invited: Pizza & Ping Pong Night!
...
//// ```
//// 
//// There are a few key things to notice: the `Date` field, which is required, has been automatically added. 
//// Additionally, the `Content-Type` has been set automatically, so your user will recieve HTML.
